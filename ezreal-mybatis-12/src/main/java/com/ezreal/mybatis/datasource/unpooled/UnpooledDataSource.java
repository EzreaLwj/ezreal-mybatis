...
public class UnpooledDataSource implements DataSource {
    ...
    private synchronized void initializerDriver() {
        if (!registerDrivers.containsKey(driver)) {
            try {
                // 注册数据库驱动
                Driver dri = (Driver) Class.forName(driver).newInstance();
                DriverManager.registerDriver(new DriverProxy(dri));
                registerDrivers.put(dri.getClass().getName(), dri);
            } catch (Exception e) {
